...
%{
/* headers with neccessary libraries */
#include "heading.h"
#include "y.tab.h"

/* Global variables to track line and position of the compiler */
int currLine = 1, currPos = 1;
%}

   /* REGULAR EXPRESSIONS */

/* constants used for defining variables and numbers */
digit		[0-9]
alpha		[a-zA-Z]
under		[_]

/* Logic to determine if a variable or keyword definition is valid */
...
/* Defines proper numbers and comments */
number		{digit}+
comment		##.*
